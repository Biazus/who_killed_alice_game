...
class SceneAction(models.Model):
    ...
    description = models.TextField(blank=True)
    action_type = models.CharField(choices=ActionType.choices, max_length=1, default=ActionType.HISTORY_ACTION)
    ...
    on_fail = models.ForeignKey("games.Scene", on_delete=models.CASCADE, related_name="failed_from", null=True, blank=True)
    on_success = models.ForeignKey("games.Scene", on_delete=models.CASCADE, related_name="succeeded_from", null=True, blank=True)
    on_hard_fail = models.ForeignKey("games.Scene", on_delete=models.CASCADE, related_name="hard_failed_from", null=True, blank=True)
