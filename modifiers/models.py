...
class Modifier(models.Model):
    ...
    # tag para tipo (furtividade, social etc.)
...
class ModifierAttributeEffect(models.Model):
    ...
    modifier = models.ForeignKey(
        "Modifier", on_delete=models.CASCADE, related_name="attribute_effects"
    )
    ...
    def __str__(self):
        return (
            f"{self.modifier} -> {self.attribute.code} ({self.sign},{self.intensity})"
        )
